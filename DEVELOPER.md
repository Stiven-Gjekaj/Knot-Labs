...
**This is a sandbox.** Knot-Labs is built for experimentation. It's not production-ready, and that's okay. The goal is to understand how it works under the hood.

**Code quality varies.** Some parts are polished, some are prototypes. That's the nature of a sandbox project.

**Ask questions.** If something doesn't make sense, it's probably not documented well enough. Open an issue or just read the code.
