...
SCRIPT_DIR = Path(__file__).resolve().parent
ROOT_DIR = SCRIPT_DIR.parent.parent  # Go up to Knot-Labs root
MESH_DIR = ROOT_DIR / "Mesh"
ECHO_DIR = MESH_DIR / "Echo"
INDEXES_DIR = ROOT_DIR / "indexes"

console = Console()
DEFAULT_KNOWN = ECHO_DIR / "known"
DEFAULT_INDEX = INDEXES_DIR / "echo_faiss_index.bin"
DEFAULT_META = INDEXES_DIR / "echo_faiss_meta.json"
DEFAULT_DIM = 128
